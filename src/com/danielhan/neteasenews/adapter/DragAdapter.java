...
public class DragAdapter extends BaseAdapter {
	...
	public DragAdapter(Context context, List<ColumnBean> channelList) {
...
//			item_text.setTextColor(context.getResources().getColor(R.color.black));
		...
		iv_delete.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				((DragGridView)parent).onItemDeleteClick(position);
			}
		});
		return view;
	}
	 ...
	 * @param isShow
	 */
	public void showAllCheckBox(boolean isShow){
		if(isShowDel != isShow){
			isShowDel = isShow;
			notifyDataSetChanged();
		}
